...
public class BorgCubeBottom extends Obstacle {
    ...
    public BorgCubeBottom() {
        if(!buffersInitialized) {
            float vertices[] = {
                    -0.5f, 0.5f, -0.5f-5.0f,	// bbl 0
                    -0.5f, -0.5f, -0.5f-5.0f,   // fbl 1
                    0.5f, -0.5f, -0.5f-5.0f,	// fbr 2
                    0.5f, 0.5f, -0.5f-5.0f,	    // bbr 3
                    -0.5f, 0.5f, 0.5f,	        // btl 4
                    -0.5f, -0.5f, 0.5f,	        // ftl 5
                    0.5f, -0.5f, 0.5f,	        // ftr 6
                    0.5f, 0.5f, 0.5f	        // btr 7
            };
            short quads[] = {
                    3, 2, 1, 0, // back
                    4, 5, 6, 7, // front
